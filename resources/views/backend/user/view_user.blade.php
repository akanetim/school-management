					  ...
					  <table id="example1" class="table table-bordered table-striped">
                        ...
                        @foreach ( $data as $key => $user)
                            <tr>
								...
								<td> {{$user->email}}</td>
								<td>
                                    <a href=" {{ route('users.edit',$user->id) }} " class="btn btn-rectangle btn-primary mb-5">Edit</a>
                                    <a href=" {{ route('users.delete', $user->id) }} " class="btn btn-rectangle btn-success mb-5" id="delete">Delete</a>
                                </td>
								{{-- <td>$320,800</td> --}}
							</tr>
                        @endforeach
